...
#
# FUNCTION INPUT ARGS
#   - in_df          = input price dataframe, where in_df takes priority over 
#                      in_fp  
...
def getPriceStats(
    ...
    min_date       = '2010-01-01',
    max_date       = '',
    outpath        = r'C:\Users\sharo\OneDrive - aiinvestor360.com\DATA\PRICE\MONTHLY',
    ...
    # building up a date filter and then applying it to the data. We 
    # create a temporary adjusted date, which is then used to filter 
    # the data.
    ###################################################################
